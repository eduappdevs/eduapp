...
export default function Toolbar(props) {
    const handleChangeFilterSession = (event) => {
        document.dispatchEvent(new CustomEvent("filter_subject", {detail: event.target.value}));
    };
                    ...
                    <ul className="scheduletoolbar-ul sessions-toolbar">
                        ...
                        <li>
                            <select onChange={
                                ...
                                name="subject"
                                id="subject_id">
                                <option defaultValue={"--"}>{props.language.chooseSubject}</option>
                                {
                        ...
                        <li onChange={SearchFilter}
                            ...
                            <Input type="text" className="searchbar_toolbar" autoComplete="off"
                                placeholder={
                    ...
                    <ul className="scheduletoolbar-ul users-toolbar">
                        ...
                        <li>
                            <select onChange={userRoleFilter}
                                ...
                                <option value="ALL">
                                    {
                                    props.language.viewAllRoles
                                }</option>
                                <option value="ADMIN">
                                    {
                                    props.language.admin
                                }</option>
                                <option value="STUDENT">
                                    {
                                    props.language.student
                                }</option>
                            </select>
                        </li>
                        <li onChange={SearchFilter}
