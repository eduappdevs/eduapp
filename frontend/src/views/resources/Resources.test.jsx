...
describe("Management panel", () => {
  test("Search Bar display", () => {
    ...
    const resourcesSearchBarIcon = component.container.querySelector(
      "#resourcesSearchBarIcon"
    );
    expect(resourcesSearchBarIcon).toHaveStyle("display:block");
  });
  test("check input in focus", () => {
    const component = render(<Resources />);
    const resourcesSearchBar = component.container.querySelector(
      "#resourcesSearchBarInput"
    );
