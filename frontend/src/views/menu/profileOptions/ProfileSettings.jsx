      ...
      <div className="profileSettings_wrapper">
        ...
        <ul className="coursesList">
          {courses.map((course) => {
            ...
            return <li className='courseItem'><p>{course.course_name}</p>
            {course.isTeacher ? <img src='/assets/teacher.svg' alt="teacher" />: <img src='/assets/student.svg' alt="student" />}</li>;
          })}
          </ul>
        </div>
