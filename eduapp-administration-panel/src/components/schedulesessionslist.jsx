    ...
    <div className="schedulesesionslist-main-container">
      <table>
        ...
        <tr>
          ...
          <th><input id='s_name' type="text" placeholder='Name'/></th>
          <th><input id='s_date' type="date" placeholder='Date'/></th>
          <th><input id='s_streaming' type="text" placeholder='Streaming'/></th>
          <th><input id='s_resources' type="text" placeholder='Resources'/></th>
          <th><input id='s_courseId' type="text" placeholder='Course' /></th>
        </tr>
