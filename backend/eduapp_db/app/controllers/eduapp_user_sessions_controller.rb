class EduappUserSessionsController < ApplicationController
  ...
  def eduapp_user_session_params
    params.require(:eduapp_user_session).permit(:session_name, :session_start_date, :session_end_date, :streaming_platform, :resources_platform, :session_chat_id, :subject_id, :user_id,  :number_repeat, :check_week_days, :diff_days)
  end
end
