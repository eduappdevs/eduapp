    ...
    <div className="users_modal">
        <div className="users_modal_content">
            ...
            <div className="users_modal_footer">
                <button className="close_button" onClick={props.close}>Cancel</button>
                <button className="close" onClick={confirmAndUpload}>Confirm and register them</button>
