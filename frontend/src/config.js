...
const CALENDAR_ID = `${API_URL}/calendar_annotations`;
const CALENDAR = `${API_URL}/calendar_annotations?user_id=`;
const SUBJECT = `${API_URL}/http://localhost:3000/subjects`;


export { API_URL, RESOURCES, EDUAPP_SESSIONS, USERS, USERS_INFO, TUITIONS, INSTITUTIONS, COURSES, CALENDAR, CALENDAR_ID, SUBJECT, CHAT_MESSAGES, CHAT_PARTICIPANTS };
