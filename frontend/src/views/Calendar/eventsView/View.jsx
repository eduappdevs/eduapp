...
export default function View(props) {
  ...
  const fetchUser = async () => {
    await asynchronizeRequest(async function () {
      if (Object.keys(props.data).length > 0) {
        let a = await USERSERVICE.findById(props.data.user_id);
        if (a) {
          setUser(a.data[0].user_name);
          setViewAuthor(true);
        }
      }
    });
  ...
  useEffect(() => fetchUser(), [props.data.user_id]);
                  ...
                  <div className="calendar-view-session-information-icon">
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 16 16"
                        onClick={async () =>
                          await teacherView(props.data.subject_id)
                        }
                      >
