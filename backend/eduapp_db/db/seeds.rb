...
UserRole.create(
  ...
  perms_session_chats: [true, true, true, true, true, true],
...
UserRole.create(
  ...
  perms_session_chats: [true, true, true, false, false, false],
...
UserRole.create(
  ...
  perms_session_chats: [false, false, true, true, true, true],
