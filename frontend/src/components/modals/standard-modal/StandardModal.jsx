 ...
 * @param {String} customCancel Custom text for Cancel.
 * @param {String} customYes Custom text for Yes.
 * @param {String} customNo Custom text for No.
 * @param {Boolean} hasCancel If it should have a cancel button.
 ...
 * @param {Function} onCancelAction What to do on Cancel.
